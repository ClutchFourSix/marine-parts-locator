...
function handleRequestForm(form) {
  form.addEventListener('submit', event => {
    ...
    const lines = [
      'Marine Parts Locator — Sourcing Request',
    ...
    const href = createMailtoLink('Marine Parts Locator Sourcing Request', lines);
    renderSuccess('request-success', 'Request summary ready', 'You can copy this summary or open a prefilled email draft.', lines, href);
  });
}
...
function handleSupplierForm(form) {
  form.addEventListener('submit', event => {
    ...
    renderSuccess('supplier-success', 'Supplier summary ready', 'You can copy this intake summary or open a prefilled email draft.', lines, href);
  });
}
